...
% todo: oops, we haven't really talked about \circ / \tri yet

\begin{exercise}
Show that there is an isomorphism
\[
\scalebox{1.3}{$\displaystyle
[q,r]\cong\sum_{f\colon q\to r}\yon^{\sum_{j\in q(\1)}r[f_1(j)]}
$}
\]
...
% We may compute
% \begin{align*}
%     [q, r] &\iso \sum_{f \colon p \to q} \yon^{\sum_{i \in q(\1)} r[f(i)]} \tag*{\cref{eqn.dir_hom}} \\
%     &\iso 
% \end{align*}
\end{solution}
\end{exercise}
