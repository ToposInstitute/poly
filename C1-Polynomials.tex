...
%% **the category \poly of polynomial functors and natural transformations can just as easily be thought of as the category of arenas and arena morphisms.

%% **in order to really talk about the latter category, we need to be able to identity identity arena morphisms and describe how arena morphisms compose
%% use this correspondence—identity arena morphism must be the arena morphism corresponding to the identity natural transformation

%% **identity
\begin{exercise}[Identity arena morphisms]
...
%% **composition
\begin{exercise}[Composing arena morphisms]
