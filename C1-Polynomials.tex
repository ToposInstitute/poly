...
\footnote{You might want the falling down to be continuous, rather than discrete. In order to get continuous time, we need to use cofunctors, which are coming in \cref{chapter2}. These examples can be as complicated as you want; the point here is just to see what ``picking up'' is!}
