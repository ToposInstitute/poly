...
\[\ell\coloneqq\1+\yon+\yon^\2+\yon^\3+\cdots,\]
 the ``list'' polynomial. The first monoid structure we'll discuss is commutative, the second is not. We will check that they satisfy the conditions in \cref{exc.list_monoids}
...
\[
  ...
  \end{cases}
\]
(its universal property can be explicitly verified).
\end{example}
