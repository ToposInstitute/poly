...
\subsubsection{Dependent sums and products of sets}
...
\subsubsection{Expanding products of sums}
...
\subsubsection{Dependent sums and products of functors $\smset\to\smset$}
...
\subsubsection{What is a polynomial functor?}
...
\subsubsection{Coproducts of polynomials}
...
\subsubsection{Polynomial morphisms, concretely.}
...
\subsubsection{Translating between natural transformations and arena morphisms.}
...
\subsubsection{Identity and composition of arena morphisms}
...
% %---- Subsection ----%
\subsection{Prepare for dynamics}\label{sec.poly.as_cat.prepare_dyn}
...
\subsubsection{The parallel product} \label{sec.parallel_prod}
...
\subsubsection{$\otimes$-monoids in $\poly$}
...
\subsubsection{Bimorphic lenses}\label{sec.poly.as_cat.prepare_dyn.bimorphic_lens}
...
\subsubsection{Products: interfaces operating on the same system}
...
\subsubsection{Parallel products: juxtaposing machines}
...
\subsubsection{Composing morphisms: wrapper interfaces} % migrating interfaces? overlaying interfaces?
...
\subsubsection{Situations} % Fields? Enclosures?
...
Finally, the fourth puts a copy of bimorphic lenses inside $\poly$, as we saw in \cref{sec.poly.as_cat.prepare_dyn.bimorphic_lens}.
