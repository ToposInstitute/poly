...
Here are two examples of $\otimes$-monoid structures carried by $\ell\coloneqq\1+\yon+\yon^\2+\cdots$, the ``list'' polynomial, one of which is commutative, the other of which is not. We will check that they satisfy the necessary conditions of an $\otimes$-monoid in \cref{exc.list_monoids}.
