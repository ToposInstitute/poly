...
\footnote{You might want the falling down to be continuous, rather than discrete. In order to get continuous time, we need to use cofunctors, which are coming in \cref{chapter2}. But it somehow gets ahead of the point being made here. These examples can be as complicated as you want; our goal is just to see what ``picking up'' can even mean!}
