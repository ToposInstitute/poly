...
\end{tikzpicture}
\]
Each box in box in this picture is labeled $m$. Whenever a box has $n$-many subboxes, it represents a map $m^{\otimes n}\to m$, for which the monoid structure gives us a canonical map
\[m^{\otimes n} \to m.\]
