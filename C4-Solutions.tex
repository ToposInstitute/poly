...
\end{tikzcd}
\]
commutes, we note that by \cref{prop.representable_nt}, both vertical maps compose functions from $S$ with $f \colon R \to S$ from the left, and by \cref{**}, both horizontal maps compose functions to $X$ with $h \colon X \to Y$ on the right.
