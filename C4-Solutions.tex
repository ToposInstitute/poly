...
\end{tikzcd}
\]
commutes, we note that both vertical maps compose functions from $S$ with $f \colon R \to S$ from the left, and both horizontal maps compose functions to $X$ with $h \colon X \to Y$ on the right.
