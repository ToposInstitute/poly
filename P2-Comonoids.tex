...
% ** discuss how state category arises formally??
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item copresheaves $I\colon\cat{C}\to\smset$, with 
\end{enumerate}
Moreover, (2) and (3) form isomorphic categories, while (3) and (4) form categories that are merely equivalent.
