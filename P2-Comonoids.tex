...
(We'll give an explicit example of a comonoid that is not a state system in \cref{**}.)
...
The polynomial $\yon^\2+\yon$ can be given a comonoid structure; to describe it, we first label its positions and directions. 
