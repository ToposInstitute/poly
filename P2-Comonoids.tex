...
\index{lens!very well behaved|seealso{cofunctor, between state categories}}\index{cofunctor!between state categories}\index{functional programming!lenses in}
...
\index{coalgebra!as cofunctor from state category}\index{functor!coalgebra for}
...
\index{discrete opfibration!as cofunctor}\index{functor!discrete opfibration|see{discrete opfibration}}
...
%**
%\end{proof}
\index{copresheaf!as cofunctor}\index{functor!copresheaf|see{copresheaf}}
