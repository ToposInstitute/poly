...
\index{dynamical system!as cofunctor}
...
\end{proposition}\index{discrete opfibration!as cofunctor}
%\begin{proof}
%**
%\end{proof}
...
\begin{proposition}\label{prop.tfae_dopf}\index{discrete opfibration!as copresheaf}
...
\subsection{More equivalences}\index{cofunctor!from state category}\index{coalgebra}\index{discrete opfibration}
