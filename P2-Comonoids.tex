...
\index{lens!vertical}\index{cartesian}
...
\index{complete graph!as state system}
\end{example}
...
\index{cofree comonoids!morphisms between}
...
\index{polynomial comonoid!coproducts of}
...
\index{copresheaves!as bicomodules}
...
\subsection{Bicomodules in dynamics}\index{bicomodules!dynamical systems and}\index{dynamical systems!as bicomodules}
...
\index{cellular automaton!running}
