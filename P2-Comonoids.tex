...
\end{definition}
\index{eraser|see{comonoid, counit of}}
\index{duplicator|see{comonoid, comultiplication of}}
\index{comonoid!counit of}
\index{comonoid!comultiplication of}
...
\index{state system!as comonoid}
