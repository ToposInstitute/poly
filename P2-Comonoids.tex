...
\begin{tikzpicture}
	...
	\begin{tikzpicture}[polybox, mapstos]
		...
		\draw[double,-] (p_pos) to[first] node[below] {} (q_pos);
	\end{tikzpicture}	
	};
	\node[right=of id1, yshift=-1.25ex] (id2) {
	\begin{tikzpicture}[polybox, mapstos]
    	\node[poly, constant dom, "$S$" left, blue] (p) {\at$s$};
    	\node[poly, cod, right=1.5cm of p.south, yshift=-1.25ex, "$\car{c}$" below, red] (r) {};
...
\begin{tikzpicture}
    \node (p1) {
	    \begin{tikzpicture}[polybox, tos, font=\tiny]
            ...
            \node[poly, right= of m.south, yshift=-1ex, "$\car{c}$" below, red] (D) {};
...
%
	\node (p2) [right=of p1] {
        \begin{tikzpicture}[polybox, tos, font=\tiny]
            \node[poly, constant dom, "$S\yon^S$" left, blue] (m') {\at$s$};
            \node[poly, right= of m'.south, yshift=-1ex, "$\car{c}$" below, red] (mm') {\at};
            \node[poly, constant, above=of mm', "$S\yon^S$" above, blue] (C') {};
            \node[poly, cod, right= of mm'.south, yshift=-1ex, "$\car{c}$" right, red] (D') {};
            \node[poly, cod, above=of D', "$\car{c}$" right, red] (mmm') {};
