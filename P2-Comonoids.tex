...
While the isomorphisms in $\smcat^\sharp$ are the same as those in $\smcat$, the non-isomorphisms can be very different.
We'll see this in our examples.
...
\begin{example}[Very well-behaved lenses product projections]\label{ex.well_behaved_boring}
