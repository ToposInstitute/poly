...
\index{state category|see{state system}}\index{state system!cofunctor from|(}
...
\begin{example}[Cofunctors from state categories to $\cat{C}$ are $\cat{C}$-coalgebras]\index{coalgebra!of polynomial comonad}\index{polynomial comonoid!coalgebra of}
...
\index{state system!cofunctor from|)}
