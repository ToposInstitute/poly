...
In particular, the finite rooted paths of these trees trace out all the ways in which the automaton can halt.
Notice, too, that every $p$-subtree of any one of these $p$-trees is another one of these three $p$-trees---do you see why?

In general the 
\end{example}

\begin{example}[Languages recognized by automata] \label{ex.dsa_lang_recog}
...
\begin{example}[Moore machines send ]
