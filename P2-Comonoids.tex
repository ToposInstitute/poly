...
\begin{enumerate}
	...
	\item Thinking of an admissible section $\cat{C}\cof\cat{N}$ as a policy, almost like a \emph{physical law}, suppose it factors through $\cat{Z}$. Would you say that this lets you ``run the law backward''? %** make this more precise
\qedhere
\end{enumerate}
\begin{solution}
\begin{enumerate}
