...
\begin{example}[Category of $\1$-trees: the terminal category]
...
\begin{exercise}[Category of trees on constants]
...
\begin{example}[Category of $\yon$-trees: the natural numbers monoid]
