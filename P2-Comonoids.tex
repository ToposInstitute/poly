...
%---- Subsection ----%
\subsection{The composition product of lenses}%\label{subsec.monoidal_struc_tri}

We have seen in many ways how $\tri$ acts on objects in $\poly$, but how does it behave on the morphisms between them?
...
Prove \cref{prop.left_dist} in terms of the formula for $\tri$ given in \eqref{eqn.composite_formula}.
\begin{solution}
