...
\begin{definition}[Substitution product] \label{def.comp}
...
\index{substitution product!on morphisms|see{substitution product, on lenses}}
\index{substitution product!on lenses|(}
...
\index{substitution product!positions and directions}
...
\footnote{In a significant sense, the substitution product should be thought of as being about dependency.} 
...
\index{substitution product!as dependency}
...
\index{substitution product!$n$-fold}
\index{substitution product!positions aas strategies}
...
\begin{exercise}[The substitution product of lenses] \label{exc.comp_prod_lens}
...
\subsection{Substitution product on corolla forests} \label{subsec.comon.comp.def.corolla}

\index{substitution product!grafting corollas}
...
\index{substitution product!involving constant polynomials}
\index{polynomial functor!application as substitution}
...
\index{substitution product!tree picture of}
...
So for instance, $\varphi\tri r$ is the substitution product of $\varphi$ with the identity lens on $r$.}
\[
\begin{tikzcd}
...
\index{dynamical system!substitution product and}
\index{dynamical system!speeding up|see{dynamical system, substitution product and}}
...
\begin{example}[Substitution products of dynamical systems can be misleading] \label{ex.comp_dyn_sys_mislead}
...
\begin{example}[Dynamical systems and the substitution product, revisited] \label{ex.dyn_sys_comp_polyboxes}
...
% Before we show the correspondence between cofunctors out of state categories and coalgebras, we first discuss how state categories arise formally from the theory of the substitution product.
