...
%\[
%	(\lim_{j\in \cat{J}} p_{j,})\tri q\cong \lim_{j\in \cat{J}}(p_{j,}\tri q)
%	\qqand
%	q\tri(\lim_{j\in \cat{J}} p_{j,})\cong \lim_{j\in \cat{J}}(q\tri p_{j,})
%\]
\[
	\left(\lim_{j\in \cat{J}} p_j\right)\tri q\cong \lim_{j\in \cat{J}}(p_j\tri q)
	\qqand
	q\tri\left(\lim_{j\in \cat{J}} p_j\right)\cong \lim_{j\in \cat{J}}(q\tri p_j)
\]
\end{theorem}
...
\begin{enumerate}
	...
	\end{equation}
	\item Take $p,q,r$ from the counterexample you found in \cref{exc.right_not_dist_prod} \cref{exc.right_not_dist_prod.prod} and check that \cref{eqn.right_prod_pullback} holds.
\qedhere
\end{enumerate}
\begin{solution}
\begin{enumerate}
    ...
    \item Given $p,q,r \in \poly$, we wish to show that \cref{eqn.right_prod_pullback} holds.
