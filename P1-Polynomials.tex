...
\begin{example}
    The corolla forest associated to the polynomial $p\coloneqq\yon^\2+\2\yon+\1$ can be drawn as follows:
...
% TODO: Why define trees when we could've just defined corollas...? Decision trees??
