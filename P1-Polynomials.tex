...
For example, in any rooted tree, the root has height $0$; every neighbor of the root has height $1$; every neighbor aside from the root of a vertex of height $1$ has height $2$; and so forth.

This allows us to define a special kind of tree that will depict our representable functors.
