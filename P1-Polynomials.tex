...
We'll assume you're already familiar with the following fact, which further justifies why we call the constructions in \cref{def.dep_sums_sets,def.dep_prods_sets} sums and products.
