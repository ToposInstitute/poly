...
% \end{tikzpicture}
% \end{equation}
Let the left state $\bul[dgreen]$ be $1$, the right state $\bul[dyellow]$ be $2$, and the bottom state $\bul[red]$ be $3$.
We designate $\bul[dgreen]$, state $1$, as the initial state.
...
\begin{enumerate}
    \item The set of states is $S\coloneqq\{1,2,3\}=\3$ (or equivalently $S\coloneqq\{\bul[dgreen],\bul[dyellow],\bul[red]\}\iso\3$).
