...
Recall from \cref{sec.poly.intro.dec} that we may view an polynomial as a scenario, each position of a polynomial as a menu, and the directions at that position as the options available on that menu.
