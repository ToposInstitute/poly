...
\begin{example}
  ...
  \]
  be the polynomial that models Caroline: its position $k\in(0,\infty)$ is the total money that Caroline receives (perhaps Caroline was prepared to receive more money than she was asking for), while its direction $r\in[0,k]$ is the money Caroline has remaining after spending some of it.
