...
\begin{example}\label{ex.two_sums_and_prods}
    ...
    \index{cartesian product|see{product}}
...
\index{product!universal property of}
...
\index{functor!representable}\index{Yoneda lemma}
...
\index{polynomial functor!constant}\index{polynomial functor!representable}\index{polynomial functor!linear}
...
\end{definition}
\index{polynomial functor!linear}
\index{polynomial functor!affine}

\begin{definition}[Monomial]
We say that $p$ is a \emph{monomial} if $p\iso I\yon^A$ for sets $I$ and $A$.
\end{definition}
\index{polynomial functor!monomial}
...
\index{polybox!for constant polynomials}
...
\index{polynomial functor!constant}\index{polynomial functor!linear}\index{polynomial functor!representable}\index{polynomial functor!monomial}
...
\index{polynomial functors!category of}
\index{polynomial functors!as full subcategory of $\smset^\smset$}
...
\index{polynomial functors!coproduct of|see{polynomial functors, sum of polynomials}}
\index{polynomial functors!product of|see{polynomial functors, product of polynomials}}
...
\index{lens!positions and directions}
...
\begin{definition}[Section; bundle] \label{def.sec-bun}\index{section|(}\index{lens!to $\yon$ as section}\index{bundle}
...
\index{monoidal structure!cartesian (products)}\index{monoidal structure!cocartesian (sums)}
...
\dnote{Does \cref{subsec.poly.cat.monoidal.prod} belong here? It feels out of place}
...
\begin{enumerate}
	...
	\]
    The factors of the above product are called Dirichlet series.\index{Dirichlet series}
...
\index{Moore machine!interface of}
...
\index{Moore machines!dependent|see{dependent dynamical system}}
...
\index{dependent Moore machine!halting}
...
\index{file reader}\index{file searcher}
...
\index{robot|)}
\index{dynamical system|)}\index{dependent dynamical system|see{dynamical system}}


%-------- Section --------%
\section{Constructing new dynamical systems from old}\label{sec.poly.dyn_sys.new}

\index{dynamical systems!constructing new from old|(}
...
\index{dynamical systems!constructing from products}
...
\index{dynamical systems!juxtaposing}
...
\index{dynamical system!wrapper interface|(}
...
\begin{example}\index{control system}
...
\begin{example}[Graphs as wiring diagrams and cellular automata]\label{ex.graph_interaction}\index{cellular automata}
...
\begin{example}[Generalized cellular automata: voting on who your neighbors are]\label{ex.cell_auto_vote_interaction}\index{cellular automata}
...
\begin{example}[Modeling your environment without knowing what it is]\index{environment!universal}
...
\begin{exercise}\dnote{Didn't we do something like this earlier somewhere?}
...
\index{polynomial functors!cartesian closed}
\index{polynomial functor!exponential}
\index{closed monoidal structure}
\index{exponential|(}
...
\index{monoidal product!parallel as pushout}
...
\index{natural transformation!cartesian|seealso{lens!cartesian}}
...
\index{monoidal structures!preservation of vertical and cartesian maps}
...
\index{lens!cartesian as exponentiable}\index{exponentiable lens|see{lens, cartesian}}
