...
\begin{remark}
[why do the inputs depend on the outputs, not the internal states?]
\end{remark}
...
\]
%Again, this is rather awkward to say... (We will see in \cref{**} a much nicer way of saying whether a word is accepted...)
\end{example}
