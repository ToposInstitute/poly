...
These can be identified respectively with a (non-dependent) function $f_\1\coloneqq\pi_1\circ f$ with signature $p(\1)\to q(\1)$ and a natural transformation $f^\sharp\colon q[f_\1(-)]\to p[-]$ whose $i\in p(\1)$ component is $f^\sharp_i\coloneqq\pi_2(f(i))\in p[i]^{q[f_\1(i)]}$.
\end{proof}
