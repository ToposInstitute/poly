...
\begin{example}[Enumerating lenses]
  ...
  How many lenses are there from $p$ to $q$? The first $p$-position can be sent to any $q$-position: 1, 2, 3, or 4. Sending it to 1 would require choosing an on-directions function $q[1]\to p[1]$, or $\4\to\3$; there are $3^4$ of these.
  Similarly, there are $3^2$ possible on-directions functions $q[2]\to p[1]$ and $3^0$ possible on-directions functions each $q[3]\to p[1]$ and $q[4]\to p[1]$, for a total of $3^4+3^2+3^0+3^0=92$ ways to choose $f_\1(1)$ and $f^\sharp_1$.
