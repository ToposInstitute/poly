...
We write the signature of such a function as
\[
    f \colon (i \in I) \to X_i.
\]
Note that the indexed family of sets completely determines this signature.
...
If $I=\2=\{1,2\}$ then a family $X\colon I\to \smset$ is just two sets, say $X_1=\{a,b,c\}$ and $X_2=\{c,d\}$. Their sum is the disjoint union
...
\end{enumerate}
As a special case, suppose $I\coloneqq\varnothing$ and $X\colon \varnothing\to\smset$ is the unique empty family of sets.
\begin{enumerate}[resume]
...
\end{enumerate}
Now $I \coloneqq \varnothing$ and $X \colon \varnothing \to \smset$ is the unique empty family of sets.
\begin{enumerate}[resume]
...
We'll assume you're already familiar with the following fact, which justifies why we call the constructions in \cref{def.dep_sums_sets,def.dep_prods_sets} sums and products.
...
\begin{enumerate}
	\item combinatorial data: a family of sets $(p[i])_{i\in I}$;
