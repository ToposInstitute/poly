...
\begin{proposition} \label{prop.presheaf_lim_ptwise}\index{functor!limit of functors}\index{functor!colimit of functors}
...
\end{example}\index{decision!impossible}
...
We can characterize the dynamics of $\varphi$ in terms of each original dynamical system $\varphi_i$ as follows.\index{dynamics}
...
\index{dependent function}\index{dynamics}
