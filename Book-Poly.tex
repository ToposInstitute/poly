...
\newenvironment{exercise}[1][]{
  ...
  \pushQED{\qed}
  \begin{exc-inner}[#1\ifthenelse{\equal{#1}{}}{\hyperlink{sol:\theequation}{Solution here}}{; \hypertarget{sol:\theequation}{solution}}]\hypertarget{ex:\theequation}{}~
}{
  \popQED
  \end{exc-inner}
}
...
\newcommand{\ctxto}{\wavyto} % b/c I can't figure out what I really want to use
                             % for this...

\newcommand{\xequals}[1]{\overset{#1}{=\joinrel=}}
\newcommand{\dd}{\mathbb{D}}
\newcommand{\determ}{\mathbb{D}\textsc{et}} 
\newcommand{\nondeterm}{\mathbb{N}\textsc{onDet}} 
\newcommand{\eucdiff}{\mathbb{E}\textsc{uc}}
\newcommand{\diffdoc}{\mathbb{D}\textsc{iff}}
\newcommand{\dispdoc}{\mathbb{D}\textsc{isp}}
\newcommand{\nondet}{\mathbb{N}\textsc{ondet}} 

\newcommand{\shp}{^\sharp}

% for making notes in text:
\newcommand{\niu}[1]{\phantom{\color{red} Niu: {#1}}}
...
\title{\titlefont Operational Semantics for Distributed Systems}
...
\mainmatter
\subfile{C1-Polynomials}
\subfile{C2-Comonoids}
\subfile{C3-Bimodules}

\appendix
\begingroup
\footnotesize

% \subfile{C4-Solutions}
