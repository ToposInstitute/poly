% !TeX root = C2-Comonoids.tex
\documentclass[Book-Poly]{subfiles}

\IfEq{\jobname}{\detokenize{Book-Poly}}{}{%
    \externaldocument{C0-Preface}
    \externaldocument{C1-Polynomials}
}
...
%---- Subsection ----%
\subsection{The monoidal structure $(\poly, \tri, \yon)$}\label{subsec.monoidal_struc_tri}
