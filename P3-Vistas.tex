...
\setcounter{chapter}{8}%Just finished 8.

%------------ Chapter ------------%
\chapter{New horizons} \label{ch.comon.vistas}
...
\begin{enumerate}
  ...
  \item Since the forgetful functor $U\colon\smcat^\sharp\to\poly$ is faithful, it reflects monomorphisms: if $f\colon\cat{C}\cof\cat{D}$ is a retrofunctor whose underlying map on carriers is monic, then it is monic. Are all monomorphisms in $\smcat^\sharp$ of this form?
